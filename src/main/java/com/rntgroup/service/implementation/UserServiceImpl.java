...
public class UserServiceImpl implements UserService {
    ...
    public User create(User user) {
        LOG.info("Method {}#create was called with param: user = {}", this.getClass().getSimpleName(), user);
    ...
    public List<User> findByName(String name, int pageSize, int pageNum) {
        LOG.info("Method {}#findByName was called with params: name = {}, pageSize = {}, pageNum = {}",
    ...
    public User update(User user) {
        LOG.info("Method {}#update was called with param: user = {}", this.getClass().getSimpleName(), user);
